...
public class Constants {
    ...
    public static String TEAMS_URL = CHAMPIONSHIPS_URL + "/teams";
    public static String MATCH_URL = "/matches";
    public static String PLAYERS_URL = CHAMPIONSHIPS_URL + "/players";
    public static String NOTIFICATIONS_URL = "/notifications";
    public static String USERS_LINEUP_URL = "/lineup";
